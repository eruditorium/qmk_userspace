...
//                                      `--------------------------'  `--------------------------'
  [_RAISE] = LAYOUT_split_3x6_3(
    KC_TILD, KC_EXLM,      KC_AT,      KC_HASH,    KC_DLR,     KC_PERC,                    KC_CIRC, RALT(KC_Y),       KC_AMPR,    Celsius,    RALT(KC_P), KC_DEL,
    ...
    _______, LSFT(KC_GRV), _______,    RALT(KC_C), XXXXXXX,    XXXXXXX,                    KC_PIPE, XXXXXXX,          RALT(KC_2), RALT(KC_3), XXXXXXX,    _______,
